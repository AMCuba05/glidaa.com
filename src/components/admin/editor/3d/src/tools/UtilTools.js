...
export const injectJS = (url, onLoad, onError) => {
...
export const saveString = (text, filename, mimeType = 'text/plain') => {
...
export const formatBytes = (bytes, decimals = 1, binaryUnits = false) => {
    if (bytes === 0) {
        return '0 Bytes';
    }
